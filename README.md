...
- **LLM-ассистент:** ( ChatGPT / DSeek )_
- **2–3 ключевых промпта:**
  1.Помоги оформить CV на HTML
  2.Помоги перенести все изменения с main на feature
- **Что правил(а) руками после генерации:** Вручную заполнила данные о себе CV, возникла путаница с ветками, прочитала информацию и настроила вручную, отсюда столько PR, Actions

## Live URL

https://1203yaroslava-ux.github.io/lab6-cv/
